...
# News 
- **[2023/12]** Our new work [EMAGE](https://github.com/PantoMatrix/EMAGE) is available, including BEATX with both FLAME head and SMPLX body parameters. The ArXiv is delayed as "on hold" for unknown reasons.
