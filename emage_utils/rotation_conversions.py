...
def axis_angle_to_rotation_6d(axis_angle):
    """
    Convert rotations given as axis/angle to 6D rotation representation.
...
def rotation_6d_to_axis_angle(rot6d):
    """
    Convert rotations given as 6D rotation representation to axis/angle.

    Args:
        rot6d: 6D rotation representation, of size (..., 6).
